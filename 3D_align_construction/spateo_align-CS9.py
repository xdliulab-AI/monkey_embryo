...
# Load the slices
slice1 = st.read('h5ad/CS9/CS9_1_D03251D414.h5ad')
slice2 = st.read('h5ad/CS9/CS9_2_D03251E211.h5ad')
#slice1, slice2
...
df.to_csv('11.3D/SPATEO/CS9/CS9_1_D03251D414_align.csv', index=False,header=False) 
df = pd.DataFrame(aligned_slices[1].obsm['align_spatial_nonrigid'])  
df.to_csv('11.3D/SPATEO/CS9/CS9_2_D03251E211_align.csv', index=False,header=False)  

allslices = ["CS9_2_D03251E211","CS9_3_D03251G212","CS9_4_D03251G513","CS9_5_D03254F211",
             "CS9_6_D03257F312","CS9_7_D03257G311","CS9_8_D03257G413","CS9_9_D03259G313","CS9_10_D03259G613"]
             

for i in range(0,9) : 
    slice1 = st.read('h5ad/CS9/'+allslices[i]+'.h5ad')
    slice2 = st.read('h5ad/CS9/'+allslices[i+1]+'.h5ad')
    ...
    st.pl.overlay_slices_2d(slices = aligned_slices, spatial_key = key_added+'_nonrigid', height=5, overlay_type='backward')
    df = pd.DataFrame(aligned_slices[1].obsm['align_spatial_nonrigid'])  
    df.to_csv('11.3D/SPATEO/CS9/'+allslices[i+1]+'_align.csv', index=False,header=False)  